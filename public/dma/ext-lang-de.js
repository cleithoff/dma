...
Ext.onReady(function() {
    ...
    if (Ext.Date) {
        Ext.Date.monthNames = ["Januar", "Februar", "M�rz", "April", "Mai", "Juni", "Juli", "August", "September", "Oktober", "November", "Dezember"];
...
Ext.define("Ext.locale.de.grid.plugin.DragDrop", {
    ...
    dragText: "{0} Zeile(n) ausgew�hlt"
});

Ext.define("Ext.locale.de.tab.Tab", {
    override: "Ext.tab.Tab",
    closeText: "Diesen Tab schlie�en"
});
