/*
 * File: app/view/UserRolePanel.js
 *
...
Ext.define('MyApp.view.UserRolePanel', {
                        ...
                        },
                        {
                            ...
                            items: [
                                me.processBagGridPanel({
                                    ...
                                    itemId: 'BagGridPanel',
                                    width: 150,
                                    title: 'verwendete Resourcen',
                                    store: 'UserRoleHasUserResourceJsonStore',
                                    columns: [
                                        {
                                            xtype: 'gridcolumn',
                                            renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                                                return record.data.user_resource.name;
                                            },
                                            dataIndex: 'label',
                                            text: 'Bezeichnung',
                                            flex: 1
    ...
    onGridPanelSelect: function(rowmodel, record, index, eOpts) {
        ...
        bagstore.filter([{property: 'user_role_id', value: record.data.id}]);
        bagstore.load();
