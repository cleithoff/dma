/*
 * File: app/view/ProductLayoutPanel.js
 *
...
Ext.define('MyApp.view.ProductLayoutPanel', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.productlayoutpanel',

    layout: {
        type: 'border'
    },
    closable: true,
    title: 'Produkt Layout',
                        ...
                        },
                        {
                            ...
                            items: [
                                ...
                                },
                                {
                                    xtype: 'textfield',
                                    anchor: '100%',
                                    fieldLabel: 'PDF Front Preview',
                                    name: 'pdf_front_preview'
                                },
                                {
                                    xtype: 'textfield',
                                    anchor: '100%',
                                    fieldLabel: 'XSL Back Preview',
                                    name: 'xsl_back_preview'
                                },
                                {
                                    xtype: 'textfield',
                                    anchor: '100%',
                                    fieldLabel: 'PDF Back Preview',
                                    name: 'pdf_back_preview'
                                },
                                {
                                    xtype: 'textfield',
                                    anchor: '100%',
                                    fieldLabel: 'XSL Front Print',
                                    name: 'xsl_front_print'
                                },
                                {
                                    xtype: 'textfield',
                                    anchor: '100%',
                                    fieldLabel: 'PDF Front Print',
                                    name: 'pdf_front_print'
                                },
                                {
                                    xtype: 'textfield',
                                    anchor: '100%',
                                    fieldLabel: 'XSL Back Print',
                                    name: 'xsl_back_print'
                                },
                                {
                                    xtype: 'textfield',
                                    anchor: '100%',
                                    fieldLabel: 'PDF Back Print',
                                    name: 'pdf_back_print'
                                },
                                {
                                    xtype: 'textfield',
                        ...
                        },
                        {
                            ...
                            items: [
                                me.processBagGridPanel({
                                    ...
                                    itemId: 'BagGridPanel',
                                    width: 150,
                                    title: 'verwendete Personalisierungen',
                                ...
                                me.processLibGridPanel({
                                    ...
                                    region: 'center',
                                    itemId: 'LibGridPanel',
                                    title: 'verfügbare Personalisierungen',
    ...
    onGridPanelSelect: function(rowmodel, record, index, eOpts) {
        ...
        bagstore.filter([{property: 'product_layout_id', value: record.data.id}]);
        bagstore.load();
    ...
    onLinkButtonClick: function(button, e, eOpts) {
        MyApp.app.getCrudControllerController().onLinkButtonClick(button, e, eOpts, function(linkrecord, librecord) {

            return {
                product_layout_id: linkrecord.data.id,
                product_personalize_id: librecord.data.id
            };
