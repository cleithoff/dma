/*
 * File: app/view/ProductWeightPanel.js
 *
...
Ext.define('MyApp.view.ProductWeightPanel', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.productweightpanel',
    ...
    onNewButtonClick: function(button, e, eOpts) {
        MyApp.app.getCrudControllerController().onNewButtonClick(button, e, eOpts, function(masterRecord, record) {
            record.data.product_item_id = masterRecord.data.id;
        });
    },
