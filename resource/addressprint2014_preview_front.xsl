...
<fo:simple-page-master master-name="main" page-height="5.51cm" page-width="11.02cm" font-family="sans-serif" margin="0.5cm" margin-left="1.1cm" margin-bottom="1.5cm">
<fo:region-body />
<fo:region-before />
