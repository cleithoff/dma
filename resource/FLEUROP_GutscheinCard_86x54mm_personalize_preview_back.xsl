...
<fo:block font-size="5pt" font-family="HelveticaNeueLT Std Med Cn" font-weight="400" color="white" text-align="center" width="65mm" line-height="10pt">
Dieser Geschenkgutschein kann eingelöst werden bei:
</fo:block>
<fo:block font-size="5.5pt" font-family="HelveticaNeueLT Std Med Cn" font-weight="400" color="white" text-align="center" width="65mm" line-height="7pt">
