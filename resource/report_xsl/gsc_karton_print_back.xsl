   ...
   <xsl:if test="/data/product_personalize/gutscheincard_line_2">
    <xsl:value-of select="/data/product_personalize/gutscheincard_line_2"/><xsl:text>&#x2028;</xsl:text> 
      ...
      <fo:block-container position="absolute" left="37mm" top="25.5mm">
      	<fo:block>
      	<fo:instream-foreign-object content-width="29mm" content-height="20mm" font-size="5pt">
			<j4lbarcode xmlns="http://java4less.com/j4lbarcode/fop" mode="inline"><Barcode1D><VALUE><xsl:value-of select="barcode"></xsl:value-of></VALUE><X>1</X><BARHEIGHT>100</BARHEIGHT><LEFTMARGIN>0</LEFTMARGIN><SET>A</SET><TYPE>INTERLEAVED25</TYPE><N>2</N><TOPMARGIN>0</TOPMARGIN><CHECKSUM>true</CHECKSUM></Barcode1D></j4lbarcode>
		</fo:instream-foreign-object>
		</fo:block>
	  </fo:block-container>
	</fo:block-container>
